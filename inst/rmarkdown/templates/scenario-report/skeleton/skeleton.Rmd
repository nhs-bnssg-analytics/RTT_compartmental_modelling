...
source(file = paste0(here::here(),'/R/fct_charts.R'))
...
This plot show the historic and projected capacity for the model run
...
## Waiting list 4 month performance

This plot show the historic and projected 4 month waiting list performance for the model run
