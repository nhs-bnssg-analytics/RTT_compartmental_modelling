...
This section shows how to import public. At the end of this section, the data will be in a shape to pass into the modelling. If the user is considering applying this article to local data, take note of what the data look like at the end of this section.
...
This is what the resulting table looks like. The column headers are still in raw form.
