...
A two column tibble containing "period" and "prop" columns, where prop
is the proportion of people that are on the waiting list in each period
that have waited for the time less that specified by the target_bin
